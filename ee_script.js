...
var lightcapita18 = lightcapita18.mask(rurpop.gt(0).and(lightcapita18.gte(0)))
...
var pop18_tier_0 = pop18_tier_0.reduceRegions({
    reducer: ee.Reducer.sum(),
    collection: Countries, scale: 1000,
})

var pop18_tier_0 = pop18_tier_0.select(['.*'],null,false);

// Table to Drive Export Example
Export.table.toDrive({
  collection: pop18_tier_0,
  description: 'pop18_tier_0_rural',
  fileFormat: 'CSV'
}); 
...
var lightcapita18 = lightcapita18.mask(urbpop.gt(0).and(lightcapita18.gte(0)))
...
Export.table.toDrive({
  collection: pop18_tier_0,
  description: 'pop18_tier_0_urban',
  fileFormat: 'CSV'
}); 
